...
## $ App.                         <chr> "I", "I", "I", "I", "I", "I", "I", "I", "…
## $ Taxon                        <chr> "Aquila heliaca", "Aquila heliaca", "Hali…
## $ Class                        <chr> "Aves", "Aves", "Aves", "Aves", "Aves", "…
## $ Order                        <chr> "Falconiformes", "Falconiformes", "Falcon…
## $ Family                       <chr> "Accipitridae", "Accipitridae", "Accipitr…
## $ Genus                        <chr> "Aquila", "Aquila", "Haliaeetus", "Haliae…
## $ Importer                     <chr> "TR", "XV", "BE", "BE", "DK", "XV", "BR",…
## $ Exporter                     <chr> "NL", "RS", "NO", "NO", "IS", "RS", "FR",…
## $ Origin                       <chr> "CZ", "RS", NA, NA, NA, "RS", NA, NA, NA,…
## $ `Importer reported quantity` <dbl> NA, NA, NA, NA, 700, NA, NA, NA, NA, NA, …
## $ `Exporter reported quantity` <dbl> 1, 1, 43, 43, NA, 1, 12, 4, 2, 4, NA, 2, …
## $ Term                         <chr> "bodies", "bodies", "feathers", "specimen…
## $ Unit                         <chr> NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, "…
## $ Purpose                      <chr> "T", "Q", "S", "S", "S", "Q", "S", "S", "…
## $ Source                       <chr> "C", "O", "W", "W", "W", "O", "C", "U", "…
```
...
##  [7] "Genus"                      "Importer"                  
##  [9] "Exporter"                   "Origin"                    
## [11] "Importer reported quantity" "Exporter reported quantity"
## [13] "Term"                       "Unit"                      
## [15] "Purpose"                    "Source"
```
...
## #   importer_reported_quantity <dbl>, exporter_reported_quantity <dbl>,
...
```r
naniar::miss_var_cumsum(wildlife)
```
...
##  7 genus                        1459         22201
##  8 importer                       71         22272
##  9 exporter                      573         22845
## 10 origin                      41518         64363
## 11 importer_reported_quantity  35295         99658
## 12 exporter_reported_quantity  23140        122798
## 13 term                            0        122798
## 14 unit                        60759        183557
## 15 purpose                      6059        189616
## 16 source                        544        190160
```
