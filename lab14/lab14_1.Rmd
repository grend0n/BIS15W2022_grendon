...
#We can see the distribution alongside the range. Violin plots tell us which one of the log 10.masses are more common within the taxon, that's why some results are symetrical and some are not. 
