...
```
# it is tidy, but the column names aren't clean, and we have some NA's.
...
#geom jitter helps organize scatter points a bit more. It sort of seperates dots close together by a bit.
...
#ggplot2 removes all NA's when plotting!This may be a problem with other graphing tools, but not so much for scatter plots.
...
## 2 herbivore       227
```
#count is like a shorter version of group_by and summarize.
...
#piping removes the data= part of earlier lab inputs. 
